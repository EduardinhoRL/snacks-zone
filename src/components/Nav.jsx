		...
		<Container>
			...
			<NavS>
				<NavLink activeClassName='activeLink' exact to='/'>
					<span className='material-icons'>room_service</span> Ordenes
				</NavLink>
				<NavLink activeClassName='activeLink' exact to='/menu'>
					<span className='material-icons'>restaurant_menu</span> Menu
				</NavLink>
			</NavS>

			<BtnCotainer>
				<BtnLogout onClick={handleLogout}>
					<span className='material-icons'>login</span> Salir
				</BtnLogout>
			</BtnCotainer>
		</Container>
	);
